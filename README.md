...
This package requires that Julia be installed, and the Julia directory be added to the system path, according to [instructions](https://julialang.org/downloads/platform/). In other words, you should be able to start Julia from a shell prompt by typing `julia`. The package works in Windows, Linux, and macOS with an Intel CPU or "Apple Silicon."
